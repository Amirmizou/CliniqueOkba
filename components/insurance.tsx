                ...
                {provider.registrationLink && (
                  <div className="mt-4">
                    <a 
                      ...
                      className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 text-xs font-semibold text-primary transition-colors hover:bg-primary/20"
                      onClick={(e) => e.stopPropagation()}
                    >
                      {isAr ? 'رابط التسجيل' : "Lien d'inscription"}
          ...
          >
            ...
            >
              ...
              <div className="flex w-full flex-col justify-center bg-card p-8 md:w-80 lg:w-96">
                ...
                {selectedProvider.registrationLink && (
                  <div className="mt-4">
                    <a 
                      href={selectedProvider.registrationLink}
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center w-full gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground transition-transform hover:scale-[1.02]"
                    >
                      {isAr ? 'رابط التسجيل' : "S'inscrire (Lien externe)"}
                      <UserPlus className="h-4 w-4" />
                    </a>
                  </div>
                )}
