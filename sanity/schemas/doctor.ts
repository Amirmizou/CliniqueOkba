...
export default defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'string',
            description: 'Numéro de téléphone spécifique au médecin (remplace le numéro par défaut)',
        }),
        defineField({
            name: 'iconName',
            ...
            options: {
                list: [
                    { title: 'Médecine générale / interne (stéthoscope)', value: 'Stethoscope' },
                    { title: 'Gynécologie / Obstétrique / Pédiatrie (bébé)', value: 'Baby' },
                    { title: 'Cardiologie (cœur)', value: 'Heart' },
                    { title: 'Cardiologie (pouls)', value: 'HeartPulse' },
                    { title: 'Endocrinologie / Diabétologie (activité)', value: 'Activity' },
                    { title: 'ORL (oreille)', value: 'Ear' },
                    { title: 'Ophtalmologie (œil)', value: 'Eye' },
                    { title: 'Dentaire / Stomatologie (sourire)', value: 'Smile' },
                    { title: 'Neurologie / Neurochirurgie (cerveau)', value: 'Brain' },
                    { title: 'Orthopédie / Traumatologie (os)', value: 'Bone' },
                    { title: 'Rhumatologie / Rééducation (accessibilité)', value: 'Accessibility' },
                    { title: 'Kinésithérapie / Physiothérapie (personne)', value: 'PersonStanding' },
                    { title: 'Podologie (pieds)', value: 'Footprints' },
                    { title: 'Radiologie / Imagerie médicale (scan)', value: 'ScanLine' },
                    { title: 'Laboratoire / Biologie médicale (fiole)', value: 'FlaskConical' },
                    { title: 'Analyses / Anatomopathologie (microscope)', value: 'Microscope' },
                    { title: 'Hématologie / Analyses (tube à essai)', value: 'TestTube' },
                    { title: 'Génétique (ADN)', value: 'Dna' },
                    { title: 'Néphrologie / Urologie (goutte)', value: 'Droplet' },
                    { title: 'Pneumologie (souffle)', value: 'Wind' },
                    { title: 'Pharmacologie / Médecine (gélule)', value: 'Pill' },
                    { title: 'Anesthésie-réanimation / Vaccination (seringue)', value: 'Syringe' },
                    { title: 'Chirurgie générale (ciseaux)', value: 'Scissors' },
                    { title: 'Urgences / Médecine d’urgence (croix)', value: 'Cross' },
                    { title: 'Infectiologie / Médecine générale (thermomètre)', value: 'Thermometer' },
                    { title: 'Dermatologie (main)', value: 'Hand' },
                    { title: 'Oncologie / Cancérologie (ruban)', value: 'Ribbon' },
                ],
            },
