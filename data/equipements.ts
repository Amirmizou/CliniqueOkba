...
export const equipements: EquipementItem[] = [
  ...
  },
  {
    ...
    title_ar: 'جهاز Alegria الآلي',
    description: 'Analyseur immunologique à écran tactile pour les bilans sanguins.',
    description_ar: 'محلّل مناعي بشاشة لمسية للتحاليل الدموية.',
  },
  {
    id: 'eq-26',
    ...
    title_ar: 'جهاز الكيمياء الحيوية الآلي',
    description: 'Traitement des échantillons sous contrôle informatique permanent.',
    description_ar: 'معالجة العينات تحت مراقبة معلوماتية دائمة.',
  },
  {
    id: 'eq-25',
    ...
    title_ar: 'طاولات العمل التقنية',
    description: 'Postes de travail ergonomiques et lumineux pour les biologistes.',
    description_ar: 'مناصب عمل مريحة ومضيئة لأخصائيي البيولوجيا.',
  },
  {
    id: 'eq-30',
